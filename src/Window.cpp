...
void Window::start() {
    ...
    m_wndw = glfwCreateWindow(2560, 1600, "Simulation", NULL, NULL);
    ...
    Window::styleInit();
    io.Fonts->AddFontFromFileTTF("../assets/fonts/ttf/Manrope-Regular.ttf",
                                 18.0f);
    io.FontDefault = io.Fonts->AddFontFromFileTTF(
        "../assets/fonts/ttf/Manrope-Regular.ttf", 18.0f);
